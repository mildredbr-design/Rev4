...
st.title("💳 Simulador Préstamo con TAE")
...
if st.button("Calcular"):
    ...
    comision = Decimal(str(capital)) * Decimal(str(comision_pct)) / Decimal("100")
    comision = comision.quantize(Decimal("0.01"), ROUND_HALF_UP)
